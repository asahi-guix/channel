...
Here the filesystem UUID is =9FBE-130E=. Create a file called
=asahi-guix.scm= and instantiate a Guix operating system record,
configured with the EFI filesystem UUID.
