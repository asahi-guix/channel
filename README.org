...
#+HTML_HEAD: <link href="https://fonts.googleapis.com/css2?family=Google+Sans:wght@300&display=swap" rel="stylesheet">
#+HTML_HEAD: <style> body { color: #4a4a4a; font-family: 'Google Sans', sans-serif; } </style>
#+AUTHOR: Asahi Guix
#+OPTIONS: toc:nil
