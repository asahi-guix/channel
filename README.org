...
#+AUTHOR: Asahi Guix
#+HTML_HEAD: <link href="https://fonts.googleapis.com/css?family=Google+Sans" rel="stylesheet">
...
(asahi-operating-system #:esp-uuid "9FBE-130E")
#+end_example
...
#+begin_src sh :results verbatim
  guix time-machine --channels=asahi/guix/channels.scm -- \
       system image --load-path=. --image-type=efi-raw --image-size=7.2GiB asahi/guix/system/install.scm
#+end_src
