...
Asahi Guix is a [[https://guix.gnu.org/manual/en/html_node/Channels.html][Guix channel]] to run the [[https://guix.gnu.org/][GNU Guix operating system]] with
the [[https://asahilinux.org/][Asahi Linux]] kernel on [[https://en.wikipedia.org/wiki/Apple_silicon][Apple Silicon]].
