...
#+TEXINFO_DIR_TITLE: Asahi Guix: (Asahi Guix)
#+TEXINFO_DIR_DESC: Asahi Linux on GNU Guix

# NOTE: We could use these, but that causes a pointless error, "org-compile-file: File "..README.info" wasn't produced...", so we just rename the files in the after-save-hook instead.
# #+TEXINFO_FILENAME: asahi-guix.info
# #+EXPORT_FILE_NAME: asahi-guix.texi
...
# after-save-hook: (lambda nil (when (and (require 'ox-texinfo nil t) (org-texinfo-export-to-info)) (delete-file "README.texi") (rename-file "README.info" "asahi-guix.info" t)))
