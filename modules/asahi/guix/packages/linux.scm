...
(define %linux-version "6.11.6")
(define %linux-revision "2")
...
(define %config
  (append (default-extra-linux-options %linux-version)
...
(define asahi-linux-source
  (make-asahi-linux-source
   ...
   "0a06jjp2a75rn7hpy4lmpngjc0yddscbi611z8lisbwl5p1y8rf0"
   (list)))
...
(define* (make-asahi-linux name
                           ...
                           (version (string-append %linux-version "-" %linux-revision "-asahi")))
  (package
    (inherit linux)
